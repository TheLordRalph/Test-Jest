...
const newBooking = new Booking("Felipe", "felipe@gmail.com", '2022-02-03', '2022-02-06', 10, newRoom);

test('Room is occupied', function() {
    expect(newRoom.isOccupied('2022-02-04')).toBeTruthy();
});

test('Room is not occupied', function() {
    expect(newRoom.isOccupied('2022-02-04')).not.toBeTruthy();
});

test('Room percentage of occupancy', function() {
    expect(newRoom.occupancyPercentage('2022-02-03', '2022-02-06')).toBe(100);
});
